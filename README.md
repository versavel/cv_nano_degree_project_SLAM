...
This is a project completed for the [Udacity Computer Vision nannodegree](https://www.udacity.com/course/computer-vision-nanodegree--nd891). The project implements SLAM (Simultaneous Localization and Mapping) for a 2 dimensional world! Using SLAM, a robot could create a map of its environment from only sensor and motion data gathered, over time. SLAM gives us a way to track the location of a robot in the world in real-time and identify the locations of landmarks such as buildings, trees, rocks, and other world features. This is an active area of research in the fields of robotics and autonomous systems. 
